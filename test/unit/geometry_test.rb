...
class GeometryTest < Test::Unit::TestCase
  context "Paperclip::Geometry" do
    ...
    should "be generated from a file" do
      ...
      assert_equal 100, @geo.height
      assert_equal 200, @geo.width
    end

    should "be generated from a file path" do
      file = fixture_file("image.jpg")
      assert_nothing_raised{ @geo = Paperclip::Geometry.from_file(file.path) }
      assert_equal 100, @geo.height
      assert_equal 200, @geo.width
    end

    should "be generated correctly from a file with a weird geometry" do
      file = fixture_file("animation.gif")
      assert_nothing_raised{ @geo = Paperclip::Geometry.from_file(file) }
      assert_equal 100, @geo.height
      assert_equal 100, @geo.width
    end

    should "not generate from a bad file" do
      file = "/home/This File Does Not Exist.omg"
      assert_raise(Paperclip::CommandLineError){ @geo = Paperclip::Geometry.from_file(file) }
    end
