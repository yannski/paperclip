...
class InterpolationsTest < Test::Unit::TestCase
  ...
  should "return the class of the model" do
    attachment = mock
    attachment.expects(:model).returns(attachment)
  ...
  should "return the basename of the file" do
    attachment = mock
    attachment.expects(:file_name).returns("one.jpg").times(2)
    assert_equal "one", Paperclip::Interpolations.basename(attachment, :style)
  end

  should "return the extension of the file" do
    attachment = mock
    attachment.expects(:file_name).returns("one.jpg")
  ...
  should "return the filename as basename.extension" do
    attachment = mock
    attachment.expects(:file_name).returns("one.jpg").times(3)
